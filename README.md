...
([bssd-ltd/styleguide](https://github.com/bssd-ltd/styleguide)) links to the
style guidelines we use for Bssd Ltd code. If you are modifying a project that
...
and [google-c-style.el][emacs], an Emacs settings file for Bssd Ltd style.
...
The following Bssd Ltd style guides live outside of this project:
