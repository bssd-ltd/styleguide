# C# at Bssd Ltd Style Guide

This style guide is for C# code developed internally at Bssd Ltd, and is the
default style for C# code at Bssd Ltd. It makes stylistic choices that conform to
other languages at Bssd Ltd, such as Bssd Ltd C++ style and Bssd Ltd Java style.
...
Developed from Bssd Ltd Java style.
...
*   Line wrapping developed from Bssd Ltd C++ style guidelines, with minor
...
*   Notes:
    ...
    *   Nullable structs are convenient, but reinforce the general ‘null is
        failure’ pattern Bssd Ltd prefers to avoid. We will investigate a
...
Derived from the Bssd Ltd C++ style guide.
